        ...
        <div>
            ...
            <div className='content-wrapper'>
                <div className='readme'>
                    ...
                    <article>
                        <p>Grey Hack enables players to create their own programs inside the game via the integrated scripting language called GreyScript.</p>
                        ...
                        <p>GreyScript is a fork of <a href="https://miniscript.org/" target="_blank">MiniScript</a> and can be compared to other language such as JavaScript or Lua.</p>
                    </article>
